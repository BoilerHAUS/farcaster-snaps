...
STAGE="$(mktemp -d "/tmp/clanker-tips-bundle.XXXXXX")"
...
echo "  3. Upload $OUT"
echo "  4. Set env var: SNAP_PUBLIC_BASE_URL=https://clanker-tips.host.neynar.app"
echo "  5. Verify: curl -sS -H 'Accept: application/vnd.farcaster.snap+json' https://clanker-tips.host.neynar.app/"
